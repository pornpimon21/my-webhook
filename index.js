          ...
          // 🔹 หัวข้อ summary
          {
            ...
            body: {
              ...
              contents: [
                ...
                { type: "text", text: "ระบบสามารถวิเคราะห์ความถนัดของคุณได้จากกิจกรรมในหมวดหมู่ต่าง ๆ เหล่านี้ 👇", wrap: true, size: "sm", color: "#555555" }
              ],
              footer: {
                type: "box",
                layout: "vertical",
                contents: [
                  { type: "text", text: "พิมพ์หรือเลือกคำจากหมวดได้เลยค่ะ ✨", wrap: true, size: "sm", align: "center", color: "#888888" }
                ]
              }
            }
          },
          ...
          // 🔹 ศิลปะ / ความคิดสร้างสรรค์
          {
            ...
            body: {
              ...
              footer: {
                ...
                layout: "vertical",
                contents: [
                  { type: "text", text: "พิมพ์หรือเลือกคำจากหมวดด้านบนได้เลยค่ะ ✨", wrap: true, size: "sm", align: "center", color: "#888888" }
                ]
              }
            }
          },
