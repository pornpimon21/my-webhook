        ...
        contents: [
          {
            ...
            body: {
              ...
              layout: "vertical",
              contents: [
                { type: "text", text: "🧠 คำกิจกรรมที่ระบบเข้าใจ", weight: "bold", size: "md", color: "#333333" },
                { type: "text", text: "ระบบสามารถวิเคราะห์ความถนัดของคุณได้จากกิจกรรมในหมวดหมู่ต่าง ๆ 👉", wrap: true, size: "sm", color: "#666666" }
              ]
            }
          },
