...
await session.save();
  ...
  return res.json({
    fulfillmentText: "ขออภัยค่ะ ระบบไม่เข้าใจคำสั่ง\nกรุณาลองใหม่อีกครั้งค่ะ 😊"
  });
});
        ...
        contents: [
          // 🔹 Bubble 1: สิ่งแวดล้อม
          {
            ...
            body: {
              ...
              spacing: "md",
              contents: [
                { type: "text", text: "🌱 สิ่งแวดล้อม", weight: "bold", size: "md", color: "#333333" },
                { type: "text", text: "สิ่งแวดล้อม, ต้นไม้, อนุรักษณ์, นิเวศวิทยา, เกษตรกรรม, เกษตร, พลังงาน, ปลูก, สัตว์ป่า, สำรวจป่า, จัดการน้ำ", wrap: true, size: "sm", color: "#666666" }
              ]
            },
            footer: {
              type: "box",
              layout: "vertical",
              contents: [
                { type: "text", text: "เลือกคำจากหมวดด้านบนได้เลยค่ะ ✨", wrap: true, size: "sm", align: "center", color: "#888888", margin: "md" }
              ]
            }
          },
          ...
          // 🔹 Bubble 2: ศิลปะ 
          {
            ...
            body: {
              ...
              spacing: "md",
              contents: [
                { type: "text", text: "🎨 ศิลปะ", weight: "bold", size: "md", color: "#333333" },
                { type: "text", text: "ศิลปะ, วาดภาพ, ออกแบบ, ความคิดสร้างสรรค์, ดนตรี, ร้องเพลง, การแสดง, ถ่ายภาพ, จิตรกรรม, ประติมากรรม", wrap: true, size: "sm", color: "#666666" }
              ]
            },
            footer: {
              type: "box",
          ...
          // 🔹 Bubble 3: เทคโนโลยี 
          {
            ...
            body: {
              ...
              spacing: "md",
              contents: [
                { type: "text", text: "💻 เทคโนโลยี", weight: "bold", size: "md", color: "#333333" },
                { type: "text", text: "เทคโนโลยี, คอมพิวเตอร์, ไอที, เขียนโปรแกรม, โค้ด, ซอฟแวร์, นวัตกรรม, ดิจิทัล, เอไอ, พัฒนาแอป, เครือข่าย", wrap: true, size: "sm", color: "#666666" }
              ]
            },
            footer: {
              type: "box",
          ...
          // 🔹 Bubble 4: ภาษา
          {
            ...
            body: {
              ...
              spacing: "md",
              contents: [
                { type: "text", text: "📚 ภาษา", weight: "bold", size: "md", color: "#333333" },
                { type: "text", text: "ภาษา, การสื่อสาร, การเขียน, การพูด, แปลภาษา, ภาษาต่างประเทศ, ล่าม, วรรณกรรม, เรียงความ, ภาษาไทย, ภาษาอังกฤษ, ภาษาเกาหลี, ภาษาจีน, ภาษาญี่ปุ่น ", wrap: true, size: "sm", color: "#666666" }
              ]
            },
            footer: {
              type: "box",
          ...
          // 🔹 Bubble 5: สุขภาพ
          {
            ...
            body: {
              ...
              spacing: "md",
              contents: [
                { type: "text", text: "🩺 สุขภาพ", weight: "bold", size: "md", color: "#333333" },
                { type: "text", text: "สุขภาพ, การแพทย์, โภชนาการ, พยาบาล, กายภาพบำบัด, สาธารณสุข, ดูแลผู้ป่วย, ปฐมพยาบาล, ทำอาหาร", wrap: true, size: "sm", color: "#666666" }
              ]
            },
            footer: {
              type: "box",
          ...
          // 🔹 Bubble 6: กีฬา
          {
            ...
            body: {
              ...
              spacing: "md",
              contents: [
                { type: "text", text: "⚽ กีฬา", weight: "bold", size: "md", color: "#333333" },
                { type: "text", text: "กีฬา, ออกกำลังกาย, ฟุตบอล, ว่ายน้ำ, กรีฑา, ฟิตเนต, ศิลปะการต่อสู้, แข่งขัน, พละ, โค้ช", wrap: true, size: "sm", color: "#666666" }
              ]
            },
            footer: {
              type: "box",
          ...
          // 🔹 Bubble 7: ผู้นำ
          {
            ...
            body: {
              ...
              spacing: "md",
              contents: [
                { type: "text", text: "👑 ผู้นำ", weight: "bold", size: "md", color: "#333333" },
                { type: "text", text: "ผู้นำ, การบริหาร, จัดการ, การตัดสินใจ, วางกลยุทธ์, เจรจา, ต่อรอง, หัวหน้า, โน้มน้าวใจ, แก้ปัญหา", wrap: true, size: "sm", color: "#666666" }
              ]
            },
            footer: {
              type: "box",
          ...
          // 🔹 Bubble 8: คณิตศาสตร์
          {
            ...
            body: {
              ...
              spacing: "md",
              contents: [
                { type: "text", text: "🧮 คณิตศาสตร์", weight: "bold", size: "md", color: "#333333" },
                { type: "text", text: "คณิตศาสตร์, คณิต, คำนวณ, ตัวเลข, ตรรกะ, สถิติ, วิเคราะห์ข้อมูล, บัญชี, พีชคณิต, เลขาคณิต, ความน่าจะเป็น" , wrap: true, size: "sm", color: "#666666" }
              ]
            },
            footer: {
              type: "box",
          ...
          // 🔹 Bubble 9: วิทยาศาสตร์
          {
            ...
            body: {
              ...
              spacing: "md",
              contents: [
                { type: "text", text: "🔬 วิทยาศาสตร์", weight: "bold", size: "md", color: "#333333" },
                { type: "text", text: "วิทยาศาสตร์, การทดลอง, วิจัย, ชีววิทยา, เคมี, ฟิสิกส์, สังเกต, ห้องแลป, ดาราศาสตร์, วิเคราะห์ผล, วิทย์", wrap: true, size: "sm", color: "#666666" }
              ]
            },
            footer: {
              type: "box",
          ...
          // 🔹 Bubble 10: สังคมศึกษา
          {
            ...
            body: {
              ...
              spacing: "md",
              contents: [
                { type: "text", text: "🌍 สังคมศึกษา", weight: "bold", size: "md", color: "#333333" },
                { type: "text", text: "สังคมศึกษา, ประวัติศาสตร์, ภูมิศาสตร์, วัฒนธรรม, รัฐศาสตร์, กฎหมาย, เศรษฐศาสตร์, การเมือง, โบราณคดี, สังคมวิทยา, มนุษยวิทยา, สังคม", wrap: true, size: "sm", color: "#666666" }
              ]
            },
            footer: {
              type: "box",
          ...
          // 🔹 Bubble 11: งานฝีมือ
          {
            ...
            body: {
              ...
              spacing: "md",
              contents: [
                { type: "text", text: "🧶 งานฝีมือ", weight: "bold", size: "md", color: "#333333" },
                { type: "text", text: "งานฝีมือ, เย็บปัก, งานไม้, ประดิษฐ์, เครื่องปั้นดินเผา, แกะสลัก, ถักไหมพรม, จัดดอกไม้, หัตถกรรม", wrap: true, size: "sm", color: "#666666" }
              ]
            },
            footer: {
              type: "box",
          ...
          // 🔹 Bubble 12: ธุรกิจ
          {
            ...
            body: {
              ...
              spacing: "md",
              contents: [
                { type: "text", text: "💼 ธุรกิจ", weight: "bold", size: "md", color: "#333333" },
                { type: "text", text: "ธุรกิจ, บริหารธุรกิจ, การตลาด, การขาย, ผู้ประกอบการ, การเงิน, การลงทุน, อีคอมเมิร์ช, วางแผน, สตาร์ทอัพ", wrap: true, size: "sm", color: "#666666" }
              ]
            },
            footer: {
              type: "box",
...
const flexResult = {
  type: "flex",
  altText: "ผลการวิเคราะห์ความถนัดของคุณมาแล้ว!",
  contents: {
    type: "bubble",
    size: "mega",
    // 🌟 ส่วนที่ 1: เพิ่มรูปภาพหน้าปก (Hero Image) ให้ดูน่าดึงดูด
    hero: {
      type: "image",
      url: "https://iili.io/KBB8GoJ.png", // แนะนำให้หารูปแบนเนอร์สวยๆ ของ มรอ. หรือรูปกราฟิกมาใส่แทนลิงก์นี้
      size: "full",
      aspectRatio: "20:10",
      aspectMode: "cover"
    },
    body: {
      ...
      contents: [
          ...
          contents: [
            {
              ...
              text: "💡 จุดเด่นของคุณ",
              weight: "bold",
              size: "sm", // ปรับเล็กลงนิดนึงให้สมดุล
              color: "#333333"
            },
            {
              type: "text",
        ...
        // 🌟 ส่วนที่ 2: กรอบแนะนำคณะ (ปรับให้มีขอบและดูเป็นระเบียบขึ้น)
        {
          type: "box",
          layout: "vertical",
          margin: "lg",
          spacing: "sm",
          backgroundColor: "#F4F8FF", // เปลี่ยนสีฟ้าให้อ่อนลงอีกนิดให้สบายตา
          borderColor: "#D0E2FF",     // เพิ่มเส้นขอบสีฟ้า
          borderWidth: "light",
          paddingAll: "15px",         // เพิ่มพื้นที่ว่างในกล่อง
          cornerRadius: "md",
          contents: [
            {
              type: "text",
              text: "🎓 คณะ/สาขาที่แนะนำใน มรอ.",
              weight: "bold",
              size: "md",
              color: "#0D99FF"
            },
      ...
      contents: [
        {
          ...
          style: "primary",
          color: "#1DB446",
          height: "sm" // ปรับปุ่มไม่ให้หนาเกินไป
        },
        {
          type: "text",
          text: "ข้อมูลนี้อ้างอิงตามทฤษฎีความถนัด RIASEC",
          size: "xxs",
          align: "center",
          color: "#BBBBBB",
          margin: "md"
    ...
    styles: {
      footer: {
        separator: true // เพิ่มเส้นคั่นบางๆ ก่อนถึงปุ่ม Footer
      }
    }
  }
};
