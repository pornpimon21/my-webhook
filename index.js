...
// STEP 0.2: เริ่มใหม่จาก 'แนะนำ'
if (userMessage === 'เริ่มใหม่แนะนำ') {
  await lineClient.replyMessage(event.replyToken, {
    type: 'text',
    text: '🔁 เริ่มระบบแนะนำใหม่แล้วค่ะ กรุณากรอกเกรดเฉลี่ยของคุณอีกครั้ง เช่น 3.00'
  });

  userSessions[userId] = { step: 'waitingGrade' }; // เคลียร์หรือเริ่ม session ใหม่
  return;
}
